...
console.log("5 >= 1 Prediction:",true);
console.log("5 >= 1 Actual:",5 >= 1);
console.log("0 === 1 Prediction:",false);
console.log("0 === 1 Actual:",0 === 1);
console.log("4 <= 1 Prediction:",false);
console.log("4 <= 1 Actual:",4 <= 1);
console.log("1 != 1 Prediction:",false);
console.log("1 != 1 Actual:",1 != 1);
console.log('"A" > "B" Prediction:',false);
console.log('"A" > "B" Actual:',"A" > "B");
console.log('"B" < "C" Prediction:',true);
console.log('"B" < "C" Actual:',"B" < "C");
console.log('"a" > "A" Prediction:',false);
console.log('"a" > "A" Actual:',"a" > "A");
console.log('"b" < "A" Prediction:',true);
console.log('"b" < "A" Actual:',"b" < "A");
console.log('true === false Prediction:',false);
console.log('true === false Actual:',true === false);
console.log('true != true Prediction:',false);
